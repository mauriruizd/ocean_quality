                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <ul {!! !$categorias[0]->subcategorias->isEmpty() ?: 'style="display : none"' !!}>
                                        <li class="titulo"><a href="#"><img src="{{ URL::to('img/'.$imagenesNav[str_slug($categorias[0]->nombre)].'.png') }}">  {{ $categorias[0]->nombre }}</a></li>
                                    ...
                                    <ul {!! !$categorias[1]->subcategorias->isEmpty() ?: 'style="display : none"' !!}>
                                        <li class="titulo "><a href=""><img src="{{ URL::to('img/'.$imagenesNav[str_slug($categorias[1]->nombre)].'.png') }}"> {{ $categorias[1]->nombre }}</a></li>
                                    ...
                                    <ul {!! !$categorias[2]->subcategorias->isEmpty() ?: 'style="display : none"' !!}>
                                        <li class="titulo"><a href=""><img src="{{ URL::to('img/'.$imagenesNav[str_slug($categorias[2]->nombre)].'.png') }}"> {{ $categorias[2]->nombre }}</a></li>
                                    ...
                                    <ul {!! !$categorias[3]->subcategorias->isEmpty() ?: 'style="display : none"' !!}>
                                        <li class="titulo "><a href=""><img src="{{ URL::to('img/'.$imagenesNav[str_slug($categorias[3]->nombre)].'.png') }}"> {{ $categorias[3]->nombre }}</a></li>
                                    ...
                                    <ul {!! !$categorias[4]->subcategorias->isEmpty() ?: 'style="display : none"' !!}>
                                        <li class="titulo"><a href=""><img src="{{ URL::to('img/'.$imagenesNav[str_slug($categorias[4]->nombre)].'.png') }}"> {{ $categorias[4]->nombre }}</a></li>
